...
public class GetCustomATPList extends UserAction<java.util.List<IMendixObject>>
{
	public GetCustomATPList(IContext context)
	{
		super(context);
	}
	...
	public java.util.List<IMendixObject> executeAction() throws Exception
	{
		...
		for (String microflowName : microflows) {
		    // Check if the microflow name contains "CustomATP"
		    if (microflowName.contains("CustomATP")) {
