...
public final class MendixDataStorageUtils {
    ...
    public static List<IMendixObject> retrieveFromDatabase(final IContext context,
                                                           final int amount, final int offset, final Map<String, Boolean> sorting,
                                                           final int depth,
    ...
    public static <T> List<T> retrieveFromDatabase(final IContext context,
        ...
        final List<IMendixObject> results = retrieveFromDatabase(
                context,
                amount,
                offset,
                sorting,
